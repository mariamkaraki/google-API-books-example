...
function createComponentFiles(options) {
    ...
    return schematics_1.mergeWith(schematics_1.apply(schematics_1.url(`./files`), [
        ...
        options.styledModule || !options.hasStyles
            ...
            : schematics_1.noop(),
        options.globalCss
            ? schematics_1.filter((file) => !file.endsWith(`.module.${options.style}`))
            : schematics_1.filter((file) => !file.endsWith(`${options.fileName}.${options.style}`)),
...
exports.componentGenerator = ngcli_adapter_1.wrapAngularDevkitSchematic('@nrwl/react', 'component');
