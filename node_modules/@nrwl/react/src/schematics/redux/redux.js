...
function normalizeOptions(host, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        let appMainFilePath;
        const extraNames = devkit_1.names(options.name);
        ...
        return Object.assign(Object.assign(Object.assign({}, options), extraNames), { constantName: core_1.strings.underscore(options.name).toUpperCase(), directory: devkit_1.names(options.directory).fileName, projectType, projectSourcePath: sourceRoot, projectModulePath: modulePath, appProjectSourcePath,
            appMainFilePath, filesPath: core_1.join(sourceRoot, projectType === 'application' ? 'app' : 'lib') });
    });
}
exports.reduxGenerator = ngcli_adapter_1.wrapAngularDevkitSchematic('@nrwl/react', 'redux');
