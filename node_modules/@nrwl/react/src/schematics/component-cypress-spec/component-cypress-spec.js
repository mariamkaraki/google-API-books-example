...
exports.componentCypressGenerator = exports.createComponentSpecFile = exports.getKnobDefaultValue = void 0;
...
function createComponentSpecFile({ project, componentPath, js, }) {
    return (tree, context) => {
        ...
        const componentFilePath = core_1.normalize(core_1.join(proj.sourceRoot, componentPath));
...
exports.componentCypressGenerator = ngcli_adapter_1.wrapAngularDevkitSchematic('@nrwl/react', 'component-cypress-spec');
