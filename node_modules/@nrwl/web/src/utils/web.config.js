...
function getWebConfig(root, sourceRoot, options, logger, esm, isScriptOptimizeOn, configuration) {
...
function _getBaseWebpackPartial(options, esm, isScriptOptimizeOn, configuration) {
    let partial = config_1.getBaseWebpackPartial(options, esm, isScriptOptimizeOn, configuration);
